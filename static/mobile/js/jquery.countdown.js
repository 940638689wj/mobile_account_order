            ...
            function showTimeLeft(ts) {
                if (ts.value <= 0) {
                    ...
                    if (ts.days == 0) {
                        ...
                        $this.find(".days_1").text(ts.days).show();
                    ...
                    if (ts.hours == 0) {
                        ...
                        $this.find(".hours_1").text(hours).show();
                    ...
                    if (ts.minutes == 0) {
                        ...
                        $this.find(".minutes_1").text(minutes).show();
                    ...
                    if (ts.seconds == 0) {
                        ...
                        $this.find(".seconds_1").text(seconds).show();
                        $this.find(".seconds_2").show();
                    }
                }
            }

            var intervalId = setInterval(scrollCountDown, 100);
